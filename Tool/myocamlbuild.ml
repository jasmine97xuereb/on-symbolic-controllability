(* OASIS_START *)
(* DO NOT EDIT (digest: 04e99bc816595256aace98c0ad7ffea5) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ...
          ("symcontrollability",
            ["src/definitions/symbolic-controllability"],
            [])
       ];
     lib_c = [];
     flags =
       [
          (["oasis_executable_main_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-std=c++17"])]);
          (["oasis_executable_main_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-std=c++17"])])
       ];
     includes =
       [
          ("src/parsing", ["src/utils"]);
          ("src/definitions/symbolic-controllability",
            ["src/definitions"; "src/parsing"; "src/utils"]);
          ("src/definitions", ["src/parsing"; "src/utils"]);
          ("src",
            [
               "src/definitions";
